  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="w-8 h-8 rounded-full text-xl text-white font-medium bg-linear-to-r from-primary to-purple-600 border border-primary/40 flex items-center justify-center hover:bg-primary/30 transition-colors"
